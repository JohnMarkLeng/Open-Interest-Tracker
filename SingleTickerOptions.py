# Open Interest Scanner for Single ticker over 150 Mil 
...
#file = r'/Users/JohnLeng/Desktop/Stocks/Stock Plot/Stock Lists/MegaLarge_Jan2021.xls'
...
#recursively sorts through data and only operates when the value is a list 
